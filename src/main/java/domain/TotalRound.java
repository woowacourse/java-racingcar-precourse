...
public class TotalRound {
    private static final String NOT_NUMBER_EXCEPTION = "[ERROR] 시도할 횟수는 숫자를 입력해야 합니다.";
    private static final String IMPOSSIBLE_NUMBER_ZERO_EXCEPTION = "[ERROR] 횟수는 0을 입력할 수 없습니다.";
