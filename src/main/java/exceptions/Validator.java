...
public class Validator {
    ...
    private static final String EXCEED_MAXIMUM_CAR_NAME_ERROR_MESSAGE = "자동차의 이름은 공백이 아니고 " + MAXIMUM_CAR_NAME_LENGTH + "자 이하여야 한다.";
    ...
    public static void validateCarNameLength(List<Car> cars) {
        for (Car car : cars) {
            if (car.getName().trim().equals("") || car.getName().length() > MAXIMUM_CAR_NAME_LENGTH) {
