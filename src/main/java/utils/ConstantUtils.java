...
public class ConstantUtils {
    ...
    public static final String OVER_FIVE_LETTERS ="[ERROR] 자동차 이름은 5자 이하이어야 한다.";
    public static final String EMPTY_LETTER ="[ERROR] 모든 자동차는 이름이 있어야 한다.";
    public static final String MUST_BE_NUMBER ="[ERROR] 시도 횟수는 숫자여야 한다.";
    public static final String MUST_BE_POSITIVE_INTEGER = "[ERROR] 시도 횟수는 양수여야 한다.";
