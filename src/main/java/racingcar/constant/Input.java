...
public class Input {
    ...
    public static final String CAR_NAME_BELOW_ERROR_MESSAGE = "[ERROR] 자동차 이름은 1자 이상 작성해야 합니다.";
    public static final String CAR_NAME_ABOVE_ERROR_MESSAGE = "[ERROR] 자동차 이름은 5자 이하로 작성해야 합니다.";
    ...
    public static final String OVERLAP_ERROR_MESSAGE = "[ERROR] 중복된 이름이 존재합니다. 서로 다른 자동차 이름을 적어주세요.";
