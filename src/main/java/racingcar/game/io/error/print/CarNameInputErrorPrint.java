...
public class CarNameInputErrorPrint {
    private static final String MORE_THAN_ONE_CAR_NAME_ERROR_MESSAGE
        = "[ERROR] 자동차 이름은 두 개 이상이어야 합니다.";
    private static final String COMMA_ERROR_MESSAGE
        = "[ERROR] 잘못된 쉼표(,) 입력입니다.";
    private static final String CHAR_ERROR_MESSAGE
        = "[ERROR] 자동차 이름은 한글 또는 영어만 가능합니다.";
    private static final String CAR_NAME_LENGTH_ERROR
        = "[ERROR] 자동차 이름은 1자 이상 5자 이하만 가능합니다.";
    private static final String NUMBER_OF_CAR_MORE_THAN_MAX_ERROR_MESSAGE
