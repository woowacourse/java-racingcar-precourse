...
public class CarRacing {
    ...
    public void run() {
        ...
        printCarRacingRepeat(carList);
        printCarRacingResult(carList);
    }
    ...
    public List<Car> initCar() {
        ...
        return CarGenerate.carGenerate(carNamesSplitList);
    }

    public void printCarRacingRepeat(List<Car> carList) {
    ...
    public void printCarRacingResult(List<Car> carList) {
