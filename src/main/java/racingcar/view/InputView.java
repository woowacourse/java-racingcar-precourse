...
public class InputView {
	...
	private static final String ERROR_NOT_DIGIT_OR_RANGE = "[ERROR] 잘못된 입력입니다. 시도할 회수는 1이상의 숫자로만 입력해주세요.";
	...
	private static void validateGameRound(String gameRound) {
		if (!isDigit(gameRound) || isZeroRound(gameRound)) {
			throw new IllegalArgumentException(ERROR_NOT_DIGIT_OR_RANGE);
		}
	}
