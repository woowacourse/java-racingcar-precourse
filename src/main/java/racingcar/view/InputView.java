...
import racingcar.utils.TrialCountGenerator;

public class InputView {
	private static final String ENTER_CAR_NAMES = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
	private static final String ENTER_TRIAL_COUNT = "시도할 회수는 몇회인가요?";
	...
	public int getTrialCount() {
		try {
			System.out.println(ENTER_TRIAL_COUNT);
			return TrialCountGenerator.generateTrialCount(Console.readLine());
		} catch (IllegalArgumentException e) {
			System.out.println(ERROR_MESSAGE + e.getMessage());
