...
public class ValidationUtilsTest {
	...
	void validCarNameTest() {
		...
		assertThat(ValidationUtils.validCarNameLen(testCarName)).isFalse();
	}

	@Test
	@DisplayName("차 이름 없을 때 테스트")
	void validCarNameBlankTest() {
		String testCarName = "";
		assertThat(ValidationUtils.validCarNameBlank(testCarName)).isFalse();
	}
