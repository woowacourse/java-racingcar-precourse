...
### 필요 기능
##### 자동차 n대 이름 입력 바탕으로 자동차 생성 기능
- 예외: 이름이 5자 이하가 아님 / 중복된 이름 / 2개 이상의 차 이름
- "," 기준으로 입력 (e.g. pobi,woni,jun)
- ",,,,"와 같은 케이스는 무시하고 (아무런 이름이 입력되지 않은 것으로 간주) 유효한 이름들만 검사해서 진행
##### 이동 횟수 입력 기능
- 예외: 정수가 아님 / 마이너스 정수임
##### 게임 시작 기능
##### n대의 자동차 랜덤 넘버에 기반한 전진/멈춤 기능
##### "-"을 활용한 n대의 자동차 현재 position 출력 기능
##### 최종 결과 확인 및 우승자 안내 기능

##### (번외 - 시간 남으면) 게임 재시작/종료 기능
