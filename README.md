...
feat 1 : 전진 조건을 결정할 수 있도록 random하게 숫자를 생성한다.

feat 2 : 입력받은 자동차 이름이 5자 이하인지 체크한다.
...
feat 8 : 1개의 Rail은 1개의 Car를 갖는다. Rail은 고유한 번호를 갖는다. 

feat 9 : 설계를 위한 기본 구조 잡기 
