...
- [ ] 자동차 이동하기
  - [ ] 자동차마다 랜덤한 수 생성
    - [ ] 숫자는 0~9 사이
  - [ ] 숫자가 4이상일 경우에는 전진, 미만이면 그대로 정지
  - [ ] 각 차수별로 이동 실행 결과 출력하기
    - [ ] 이동한 횟수만큼  '-'로 표현 
    - [ ] 출력 양식 👉` gabi : ---`
- [ ] 주어진 횟수가 모두 끝난 후 우승자 알려주기
  - [ ] 우승자는 1명 이상
  - [ ] 우승자 여러명인 경우 쉼표로 구분해서 출력
  - [ ] 출력 양식 👉 `최종 우승자 : honey, noze`
...
- [ ] 자동차 이름
  - [ ] 입력한 이름의 길이가 5를 초과하는 경우
  - [ ] 이름 사이에 공백을 넣은 경우
  - [ ] 이름과 이름 사이에 쉼표만 있지 않은 경우(추가로 공백이 들어있는 경우)
- [ ] 시도할 횟수
  - [ ] 숫자가 아닌 문자를 입력한 경우
  - [ ] 숫자 사이에 공백이 입력된 경우
