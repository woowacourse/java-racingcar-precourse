...
- 클래스 메소드
    ...
    - [X] 서킷의 모든 차에게 전진 명령을 내리기 (`public`)
    - [X] 현재 경기의 서킷 상태 제공하기 (`public`)
    - [X] 경기가 끝났는지 여부 확인해주기 (`public`)
...
- 클래스 메소드
    ...
    - [X] 자동차 이름 입력 요청하기 (`private`)
    - [X] 전진 시도 횟수 입력 요청하기 (`private`)
    - [X] 현재의 서킷 상태 출력하기 (`private`)
    - [X] 게임의 승자 출력하기 (`private`)
    - [X] 게임 실행하기 (`public`)
