...
### 게임의 진행(각 회 마다)
- 각 차 마다 무작위 난수 생성
- 무작위 난수에 따라 차가 갈지 안갈지 결정
  - 차가 간다면 현재 차의 위치 업데이트?
- 각 회마다 실행 결과 보여주기
...
### 예외 상황
- 에러 문구 출력
- 자동차 이름 사이에 쉼표가 아니라 다른 기호가 들어감
- 이름이 5자 이상임
- 사용자가 횟수 입력시에 숫자 말고 문자를 넣음
- 아무도 출발하지 않아서 간 거리가 0 인 경우 모두가 우승인가?
