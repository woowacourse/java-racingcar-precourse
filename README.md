...
5. 시도할 횟수 입력 받는 기능
6. 입력받은 시도할 횟수 저장하는 기능
7. 자동차가 0과 9사이의 random number 생성하는 기능
8. 생성한 random number가 4이상인지 아닌지 판단하는 기능
  ( 4 이상이면 그대로 반환, 4 미만이면 0 반환하도록 )
9. <9>에서 판단된 수로 position 변경 기능
10. "실행결과" message 출력 기능
11. 각 자동차별로 position(-) 출력 기능 (Car의 toString 메소드 사용)
12. 목록의 <8~12>을 수행하는 기능
13. 시도할 횟수만큼 <13>을 수행하는 기능
