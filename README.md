...
1. IllegalArgumentException 발생 o
2. [ERROR] 문구 출력 o
...
13. 기능목록 업데이트가 됐는지?
14. 기능목록에 예외경우도 있는지?
15. 리드미에 설명, 프로젝트 구조, 기능목록, 실행방법, 기능설명이 적혀있는지?
16. 코드 정렬을 했는지 (Ctrl+Alt+L)?
17. 매직넘버를 상수처리 했는지?
18. 구현 순서가 지켜졌는지? (상수, 클래스 변수 - 인스턴스 변수 - 생성자 - 메서드)
