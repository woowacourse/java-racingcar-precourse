...
### 경기장
- 자동차들의 위치 값을 비교할 수 있다.
- 게임이 완료 된 후 누가 우승했는지 출력한다.
- 자동차들의 이름과 위치를 출력할 수 있다.
...
- [x] 보장된 이름이 아닐 시 에러 출력하기
    - 보장된 이름(5자리 이하의 대,소영문 이름이며, 숫자, 특수문자, 스페이스 등이 포함되있지 않은 이름)
- [ ] 이동 횟수 입력받기
- [ ] 보장된 이동 횟수가 아닐시 에러 출력하기 
    - 보장된 이동 횟수(숫자이며, 1 이상인 자연수)
- [ ] 0과 9사이의 랜덤 값 입력받기
- [ ] 랜덤 값이 4이상 일시 Car 객체의 위치 값 변경하기 
- [ ] 랜덤 값이 3이하 일시 Car 객체의 위치 값 변경하지 않기 
