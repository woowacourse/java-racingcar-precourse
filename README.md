...
## 🎯 구현할 기능 목록
- racingcar 객체 생성
    - 객체가 자동차가 아닐 가능성을 고려해서 클래스 분할
    - 자동차가 랜덤이 아닌 다른 방법으로 전진할 가능성 고려해서 클래스 분할
- 유저 입력에 따른 racingcar 이름 설정
    - 유저 입력 예외처리
- racingcar 들이 달리는 track 객체 구현
- 멈춤(0-3), 전진(4-9) 구현
- 유저 입력에 따른 멈춤, 전진 기능 반복
    - 유저 입력 예외처리
- 최종 승자 출력 구현
