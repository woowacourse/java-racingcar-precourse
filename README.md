...
---
## 📄 기능 목록
- [x] 0 ~ 9 까지의 정수를 반환하는 객체 생성
  - [x] 해당 숫자가 4이상인지 판별하는 메소드 필요
- [x] Car 객체에 position을 증가시킬 수 있는 메소드 생성 (setter는 허용하지 않음)
- [x] 사용자 입력값을 변형하고 검증하는 메소드 생성
- [x] 사용자 입력 받기
- [x] 차수별 실행 결과 표시하기
- [x] 최종우승자 판별하기
  - [x] 여러 명인 경우에 쉼표로 구분하여 표기

## ❌ 예외 목록
- [x] 사용자 입력한 자동차 이름들 validate
  - [x] 각 자동차 이름의 길이가 5이하인가?
  - [x] 자동차 이름에 blank가 들어있지 않은가?
  - [x] 자동차 이름을 입력하지 않은 경우 고려
- [x] 사용자가 입력한 시도할 횟수 validate
  - [x] 숫자인가?
  - [x] 양수인가?
