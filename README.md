...
8. 진행 상황을 출력하는 기능.
9. 경주 결과를 출력하는 기능.
10. 자동차 경주 게임을 진행하는 기능. 즉, 주어진 기간동안 경주하고, 진행 결과를 출력하고, 우승자를 가려내는 기능.
11. 사용자가 입력을 잘못한 상황을 처리하는 기능. 제대로 된 입력을 할 때까지 다시 물어보는 기능.



## 예외 상황

### 1. 사용자가 자동차 이름을 입력할 때

- 두 개 이상의 자동차 이름을 입력하면서도 구분자(',')를 넣지 않고 입력.
- 구분자(',')를 마지막 자동차 이름에도 넣어 입력.
- 자동차 이름과 구분자(',') 이외의 것(예시: ' ')을 입력.
- 하나 이상의 자동차 이름을 5자 초과하여 입력.

### 2. 사용자가 시도할 회수를 입력할 때

- 사용자가 시도할 회수를 입력할 때, 자연수가 아닌 수를 입력.
- 사용자가 시도할 회수를 입력할 때, 수가 아닌 것(예: 글자)을 입력.
