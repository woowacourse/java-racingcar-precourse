...
- 사용자에게 값을 입력받는 기능
- 입력받은 값이 올바른지 체크(예외처리)하는 기능
- 입력받은 값을 ,(쉼표) 기준으로 파싱하는 기능
- 차량을 앞으로 전진시키는 기능
- n대의 차량 수에 맞게 n번의 랜덤 값을 구하는 기능
- 구한 랜덤 값이 4 이상일 경우 전진하는 기능
- 예외처리시 [ERROR]로 시작하는 메시지를 출력하고 거기부터 다시 입력받는 기능
- 우승자가 여러 명일 경우 쉼표로 구분해서 출력하는 기능
