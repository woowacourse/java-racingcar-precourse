...
- 클래스 메소드
    - [ ] 차 이름 문자열의 길이 검증 (`private`)
    - [ ] 차 이름 배열 문자열의 중복 요소 검증 (`private`)
    - [ ] 차 이름 배열 문자열을 차 이름 문자열로 변환 (`public`)
    - [ ] 시도 횟수 문자열의 형태 검증 (`private`)
    - [ ] 시도 횟수 문자열의 `Integer` 범위 여부 검증 (`private`)
    - [ ] 시도 횟수 문자열의 범위 검증 (`private`)
    - [ ] 시도 횟수 문자열을 정수로 변환 (`public`)
