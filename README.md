...
- [ ] 현재 1등인 자동차들을 찾아내는 기능
- [ ] 최종 우승자를 출력하는 기능
  - [입출력 요구사항](#-출력)에 맞게 출력한다.
- [ ] 각 예외 상황에 맞는 에러 문구를 출력하는 기능
